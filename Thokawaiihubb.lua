      ...
      if _G.F then
        AttackNoCD() 
            ...
            game:GetService("RunService").RenderStepped:Connect(function()
                if _G.F then
                    pcall(function()
                        if game.Players.LocalPlayer.Character:FindFirstChild("Combat") or game.Players.LocalPlayer.Character:FindFirstChild("Black Leg") or game.Players.LocalPlayer.Character:FindFirstChild("điện") or game.Players.LocalPlayer.Character:FindFirstChild("Karate Người Cá") or game.Players.LocalPlayer.Character:FindFirstChild("Hơi Thở Của Rồng") or game.Players.LocalPlayer.Character:FindFirstChild("Superhuman") or game.Players.LocalPlayer.Character:FindFirstChild("Karate Cá Mập") then
